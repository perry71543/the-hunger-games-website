  ...
  return (
    <section className="archive-shell pb-8">
      <div className="archive-card-enhanced archive-panel relative overflow-hidden p-3">
        <div className="relative aspect-[16/7] min-h-[190px] overflow-hidden rounded-[4px] border border-orange-100/10 bg-black/35">
          <Image
            src={src}
            alt={alt}
            fill
          ...
          <div className="absolute inset-x-0 bottom-0 border-t border-orange-200/10 bg-black/50 px-5 py-4 backdrop-blur">
